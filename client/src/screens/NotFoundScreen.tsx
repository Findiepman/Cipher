 ...
 *
 * There is no router in this app yet — AppRoot matches the one deep link that
 * exists by hand — so nothing renders this automatically. It takes the path it
  ...
  return (
    <div className="not-found">
      <div className="not-found-panel">
        {/* The app's mark. Decorative here — the heading below says where you
